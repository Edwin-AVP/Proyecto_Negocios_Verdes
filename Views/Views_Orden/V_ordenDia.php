...
<?php 
require_once "../../Controller/Controller_Orden/C_ordendia.php";
  ...
  <b style="font-size:100%;"><?php  echo $od; ?></b>
    ...
    while($result=mysqli_fetch_array($result1)){
      //$id_p = $result[0];
      $result2 = mysqli_query($conection,"SELECT * from h_producto where ID_PRODUCTO = '$result[9]' and HP_ID_ORDEN = '$result[0]' ");
      $result_P=mysqli_fetch_array($result2);
      $result3 = mysqli_query($conection,"SELECT SUM(cantidadProductoSolicitado) from orden a JOIN ordenproducto e on a.ID_ORDEN = e.FK_ID_ORDEN and a.ID_ORDENDELDIA = $id[0]
      where e.FK_ID_PRODUCTO = '$result[9]'");
    ...
    <div class="form-row">
      ...
      <div class="col-md-2 mb-3">
        ...
        <input type="text" class="form-control" value="<?php echo $result4[0] ?>" aria-label="Disabled input example" required readonly>
      </div>
      <div class="col-md-2 mb-3">
      ...
      <div class="col-md-2 mb-3">
        <label>Total</label>
        <?php $total = ($result_P['valorUnidad'] * $result4[0]) ?>
