<?php
    ...
    if($cantidad > 0){
       ...
       // INSERT INTO material(nombreMaterial, codigoMaterial, unidadMedidaMaterial, valorMaterial, tipoMaterial, cantidadMaterialInventario) VALUES
        //('$nombre', '$codigo','$unidad', '$valor', '$tipo', 0)"        codigo	nombre	motivo	fecha	cantidad	unidad	tipo	
